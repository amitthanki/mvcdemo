...
namespace ERSBackgroundProcess
{
    public class GPSHeaderService
    {
        ...
        {
            public override AuthenticationKey AuthenticationKey => throw new NotImplementedException();

            public override DecryptionKey DecryptionKey => throw new NotImplementedException();

            public override EncryptionKey EncryptionKey => throw new NotImplementedException();

            public override SignatureKey SignatureKey => throw new NotImplementedException();

            public override bool SupportsDataEncryption => throw new NotImplementedException();

            public override bool SupportsDigitalSignature => throw new NotImplementedException();
