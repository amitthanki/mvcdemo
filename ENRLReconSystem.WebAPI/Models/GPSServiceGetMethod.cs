...
using ENRLReconSystem.WebAPI.srvAEMemberDemographics;
using ENRLReconSystem.WebAPI.srvAEMemberEligibility;
using ENRLReconSystem.WebAPI.srvAETrrSummary;
using ENRLReconSystem.WebAPI.srvAECMSTransaction;
using ENRLReconSystem.WebAPI.srvAEOutOfAreaOption;
//using ENRLReconSystem.WebAPI.srvAEGetTRRDetails;
...
{
    //public class GPSServiceGetMethod
    //{
    ...
    //    //            var responseData = response.demographics[0];
    //    //            if (!responseData.IsNull())
    //    //            {
    //    //                objDOGEN_AEGPSServiceTrace.ResponseData = new System.Web.Script.Serialization.JavaScriptSerializer().Serialize(responseData).ToString();
    //    //                objDOGEN_AEGPSServiceTrace.StatusLkup = (long)WebserviceStatus.Success;
    //    //                MappingDemographicDetails(responseData, request.medicareClaimNumber, out objDOGEN_GPSData);
    //    //            }
    //    //            else
    //    //            {
    ...
    //    //private void MappingDemographicDetails(demographics responseData, string HICN, out DOGEN_GPSData objDOGEN_GPSData)
    //    //{
    //    //    objDOGEN_GPSData = new DOGEN_GPSData();
    //    //    try
    //    //    {
    //    //        objDOGEN_GPSData.AddressLine1 = responseData.preference.address.postalAddress.addressLine1.NullToString();
    //    //        objDOGEN_GPSData.AddressLine2 = responseData.preference.address.postalAddress.addressLine2.NullToString();
    //    //        //objDOGEN_GPSData.ApplicationApprovedStatus =responseData
    //    //        objDOGEN_GPSData.City = responseData.preference.address.postalAddress.city.NullToString();
    //    //        //objDOGEN_GPSData.ContractNumber= responseData.businessType.
    //    //        objDOGEN_GPSData.County = responseData.preference.address.countyName.NullToString();
    //    //        objDOGEN_GPSData.State = responseData.preference.address.postalAddress.state.NullToString();
    //    //        objDOGEN_GPSData.ZipCode = responseData.preference.address.postalAddress.zip5.NullToString();
    //    //        objDOGEN_GPSData.ZipCode4 = responseData.preference.address.postalAddress.zip4.NullToString();
    //    //        objDOGEN_GPSData.DOB = responseData.person.dateOfBirth.IsNull() ? (DateTime?)null : responseData.person.dateOfBirth.ToDateTime();
    //    //        objDOGEN_GPSData.FirstName = responseData.person.personName.firstName.NullToString();
    //    //        objDOGEN_GPSData.Gender = responseData.person.gender.NullToString();
    //    //        objDOGEN_GPSData.LastName = responseData.person.personName.lastName.NullToString();
    //    //        objDOGEN_GPSData.MiddleName = responseData.person.personName.middleName.NullToString();
    //    //        //objDOGEN_GPSData.GPSOOADisenrollmentDate= responseData.
    //    //        //objDOGEN_GPSData.HICN = responseData.person.medicareClaimNumber.NullToString();
    //    //        objDOGEN_GPSData.HICN = HICN;
    //    //        objDOGEN_GPSData.MemberId = responseData.memberNumber.NullToString();
    //    //        objDOGEN_GPSData.HouseholdId = responseData.accountId.NullToString();
    //    //        objDOGEN_GPSData.IndividualId = responseData.individualId.ToInt64();
    //    //        objDOGEN_GPSData.LOB = responseData.lob.NullToString();
    ...
    //    //public void GetMemberEligibilityService(DOGEN_GPSServiceRequestParameter objDOGEN_GPSServiceRequestParameter, out List<MacroGetEffectiveDate> lstDOGEN_GPSData, out string errorMessage)
    //    //{
    ...
    //    //    objDOGEN_AEGPSServiceTrace.GEN_QueueRef = objDOGEN_GPSServiceRequestParameter.ERSCaseId.ToInt64();
    //    //    lstDOGEN_GPSData = new List<MacroGetEffectiveDate>();
    ...
    //    //            objDOGEN_AEGPSServiceTrace.ResponseData = new System.Web.Script.Serialization.JavaScriptSerializer().Serialize(eligibiltyDetails).ToString();
    ...
    //    //        else
    //    //        {
    //    //            errorMessage = "GPShouseHold ID is Invalid";
    //    //            objDOGEN_AEGPSServiceTrace.StatusLkup = (long)WebserviceStatus.Failed;
    //    //            objDOGEN_AEGPSServiceTrace.ResponseData = errorMessage;
    //    //        }
    //    //    }
    ...
    //    //private void MappingELigibilityInformation(accountType[] eligibiltyDetails, out List<MacroGetEffectiveDate> lstDOGEN_GPSData)
    //    //{
    //    //    lstDOGEN_GPSData = new List<MacroGetEffectiveDate>();
    //    //    MacroGetEffectiveDate doMacroGetEffectiveDate;

    //    //    for (int i = 0; i < eligibiltyDetails.Count(); i++)
    //    //    {
    //    //        doMacroGetEffectiveDate = new MacroGetEffectiveDate();
    //    //        doMacroGetEffectiveDate.HouseholdId = eligibiltyDetails[0].accountId;
    ...
    //    //        //doGEN_GPSData.DOB = Convert.ToDateTime(eligDetails.dateOfBirth);
    ...
    //    //        {
    //    //            List<applicationType> applications = eligDetails.application.OrderByDescending(x => x.proposedEffectiveDate).ToList();
    //    //            doMacroGetEffectiveDate.EffectiveDate = applications[0].proposedEffectiveDate;

    //    //        }
    //    //        doMacroGetEffectiveDate.TermDate = eligibiltyDetails[0].terminationDate;
    //    //        //List<applicationType> applications = eligDetails.application.OrderByDescending(x => x.proposedEffectiveDate).ToList();

    //    //        //  doGEN_GPSData.PlanTermDate = eligDetails.
    //    //        //if (!eligDetails.application.IsNull())
    //    //        //{
    //    //        //    doGEN_GPSData.LOB = eligDetails.application[0].businessSegment.NullToString();
    //    //        //    doGEN_GPSData.EffectiveDate = applications[0].proposedEffectiveDate.ToDateTime();
    //    //        //}
    //    //        lstDOGEN_GPSData.Add(doMacroGetEffectiveDate);
    //    //    }
    //    //}
    ...
    //    //public ExceptionTypes GetTRRDetails(string strTransactionId, ref string responseData, out string errorMessage)
    //    //{
    ...
    //    //    objDOGEN_AEGPSServiceTrace.CreatedByRef = 1;
    //    //    objDOGEN_AEGPSServiceTrace.WebServiceMethodName = MethodBase.GetCurrentMethod().ToString();
    ...
    //    //                {
    //    //                    responseData = objDOGEN_AEGPSServiceTrace.ResponseData;
    ...
    //    //        objDOGEN_AEGPSServiceTrace.StatusLkup = (long)WebserviceStatus.Failed;
    //    //        objDOGEN_AEGPSServiceTrace.ResponseData = errorMessage;
    //    //        BLCommon.LogError(1, MethodBase.GetCurrentMethod().ToString(), (long)ErrorModuleName.GPSWebservice, (long)ExceptionTypes.Exception, ex.ToString(), ex.ToString());
    ...
    public class MacroGetEffectiveDate
    {
